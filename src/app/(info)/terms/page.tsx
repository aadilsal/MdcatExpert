export default function TermsPage() {
    return (
        <article className="prose prose-blue max-w-none">
            <h1 className="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-8">Terms of <span className="text-primary-600">Service</span></h1>
            <p className="text-lg text-gray-500 dark:text-slate-400 font-medium mb-12">Last Updated: February 22, 2026</p>

            <section className="space-y-6 mb-12 text-gray-600 dark:text-slate-400 font-medium leading-relaxed">
                <h2 className="text-2xl font-black text-gray-900 dark:text-white pt-8 border-t border-gray-100 dark:border-slate-800 uppercase tracking-wider text-sm">1. Acceptance of Terms</h2>
                <p>
                ...
                <h2 className="text-2xl font-black text-gray-900 dark:text-white pt-8 border-t border-gray-100 dark:border-slate-800 uppercase tracking-wider text-sm">2. Use of the Platform</h2>
                <p>
                ...
                <h2 className="text-2xl font-black text-gray-900 dark:text-white pt-8 border-t border-gray-100 dark:border-slate-800 uppercase tracking-wider text-sm">3. Accuracy of Materials</h2>
                <p>
                ...
                <h2 className="text-2xl font-black text-gray-900 dark:text-white pt-8 border-t border-gray-100 dark:border-slate-800 uppercase tracking-wider text-sm">5. Modifications to Service</h2>
                <p>
