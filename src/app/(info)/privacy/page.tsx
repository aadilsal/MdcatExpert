export default function PrivacyPage() {
    return (
        <article className="prose prose-blue max-w-none">
            <h1 className="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-8">Privacy <span className="text-primary-600">Policy</span></h1>
            ...
            <section className="space-y-6 mb-12 text-gray-600 dark:text-slate-400 font-medium leading-relaxed">
                <h2 className="text-2xl font-black text-gray-900 dark:text-white pt-8 border-t border-gray-100 dark:border-slate-800 uppercase tracking-wider text-sm">1. Information We Collect</h2>
                <p>
                ...
                <h2 className="text-2xl font-black text-gray-900 dark:text-white pt-8 border-t border-gray-100 dark:border-slate-800 uppercase tracking-wider text-sm">2. How We Use Your Data</h2>
                <p>
