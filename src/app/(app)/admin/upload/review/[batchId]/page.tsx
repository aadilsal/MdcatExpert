            ...
            <div className="space-y-6">
                {questions.map((q, idx) => (
                    <motion.div
                        ...
                        key={q.id}
                        className={`bg-surface rounded-4xl p-8 border ${editingId === q.id ? "border-primary-500 ring-4 ring-primary-500/5" : "border-gray-100"} shadow-xl shadow-gray-200/20 dark:shadow-none transition-all`}
                    >
                        <div className="flex items-start justify-between gap-6 mb-6">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className={`p-2 rounded-xl transition-all disabled:opacity-50 disabled:pointer-events-none ${q.status === "approved" ? "bg-emerald-500 text-white" : "border border-surface-border text-gray-400 hover:bg-emerald-50 hover:text-emerald-500"}`}
                                >
                                ...
                                <button
                                    ...
                                    disabled={statusUpdatingId !== null}
                                    className={`p-2 rounded-xl transition-all disabled:opacity-50 disabled:pointer-events-none ${q.status === "rejected" ? "bg-red-500 text-white" : "border border-surface-border text-gray-400 hover:bg-red-50 hover:text-red-500"}`}
                                >
                                    {statusUpdatingId === q.id ? (
                                ...
                                >
                                    ...
                                    />
                                    <div className={`p-2 rounded-xl border transition-all ${q.image_url ? "border-emerald-300 bg-emerald-50 text-emerald-600" : "border-surface-border text-gray-400 hover:bg-primary-50 hover:text-primary-500 hover:border-primary-300"}`}>
                                ...
                                {editingId === q.id ? (
                                    ...
                                    <button
                                        ...
                                        className="p-2 rounded-xl border border-surface-border text-gray-400 hover:bg-primary-50 hover:text-primary-500 disabled:opacity-40 disabled:pointer-events-none"
                                    >
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-xl border border-surface-border text-gray-400 hover:bg-red-50 hover:text-red-500 disabled:opacity-50 disabled:pointer-events-none"
                                >
                                    {deletingId === q.id ? (
                                        <Spinner size="md" className="border-gray-300 border-t-red-600" />
                                    ) : (
                        ...
                        {q.image_url && (
                            <div className="mb-6">
                                <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Image URL: {q.image_url}</p>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-50 dark:border-slate-800 dark:border-slate-800 flex flex-wrap items-center gap-4">
                            <span className="px-3 py-1 bg-gray-100 rounded-lg text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest">{q.subject}</span>
